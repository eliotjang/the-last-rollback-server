...
export const updateUserInfo = async (nickname, accountClass, accountId) => {
  await pools.USER_DB.query(SQL_QUERIES.UPDATE_USER_INFO, [nickname, accountClass, accountId]);
};
